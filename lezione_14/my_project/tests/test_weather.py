#from lezione_14.my_project.weather import check_weather
...
def test_check_weather2():
    ...
    assert check_weather(5.00) == "average", "temperatures between 10 and 20 degree must be considereted as average temperature"
